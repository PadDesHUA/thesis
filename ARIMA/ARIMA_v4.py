...
thessaloniki_temperatures = pd.read_csv(os.path.join(thes_dir, 'weather_thess.csv'))
internet_traffic = pd.read_csv(os.path.join(data_dir, 'internet_usage_converted.csv'))
